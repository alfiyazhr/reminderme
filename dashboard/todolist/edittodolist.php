...
$query = "select * from tb_todolist where id_list='$id_list_get'";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query = "update tb_todolist set task='$task', matkul='$matkul', tanggal='$tanggal' where id_list='$id_list_get'";

    mysqli_query($koneksi, $query);
    header('location: todolist.php?pesan=edit_sukses');
}
...
else if($url == "/tugas_akhir/dashboard/todolist/todolist.php" || $url == "/tugas_akhir/dashboard/todolist/tambahtodolist.php" || $url == "/tugas_akhir/dashboard/todolist/edittodolist.php?id_list=$id_list_get"){
    $isActive = "todolist";
}
else{
    $isActive = "";
        ...
        <div class="container">
            ...
            <main>
                ...
                <form action="" method="post">
                    ...
                    <input type="date" id="tanggal" name="tanggal" placeholder="Input Tanggal..." required value="<?= $show["tanggal"];?>">
                    <label for="task">Nama Task atau Tugas</label>
                    <input type="text" id="task" name="task" placeholder="Input Tugas..." required value="<?= $show["task"];?>">
                    <label for="matkul">Mata Kuliah</label>
                    <select name="matkul" id="matkul" required value="<?= $show["matkul"];?>">
